 ...
 */
            ...
            /**
            *  TimeSpan_type0 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TimeSpan_type0
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":TimeSpan_type0",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "TimeSpan_type0",
                           xmlWriter);
                                            ...
                                            if (localDuration != null){
                                                ...
                                                writeAttribute("",
                                                         "Duration",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDuration), xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            new javax.xml.namespace.QName("","Duration"));
                                      ...
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDuration));
    ...
    public static class Factory{
        ...
        */
        public static TimeSpan_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TimeSpan_type0 object =
                new TimeSpan_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"TimeSpan_type0".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TimeSpan_type0)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    // handle attribute "Duration"
                    java.lang.String tempAttribDuration =
                        
                                reader.getAttributeValue(null,"Duration");
                            
                   if (tempAttribDuration!=null){
                         java.lang.String content = tempAttribDuration;
                        
                                                 object.setDuration(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(tempAttribDuration));
                                            
                    } else {
                       
                    }
                    handledAttributes.add("Duration");
