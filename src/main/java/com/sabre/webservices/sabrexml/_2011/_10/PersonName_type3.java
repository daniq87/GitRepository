 ...
 */
            ...
            /**
            *  PersonName_type3 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class PersonName_type3
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = PersonName_type3
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PersonName_type3",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "PersonName_type3",
    ...
    public static class Factory{
                ...
                public static PersonName_type3 fromString(java.lang.String value,
                                                    java.lang.String namespaceURI){
                    PersonName_type3 returnValue = new  PersonName_type3();
                ...
                public static PersonName_type3 fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return PersonName_type3.Factory.fromString(content,namespaceUri);
                    } else {
                       return PersonName_type3.Factory.fromString(content,"");
                    }
                }
        ...
        */
        public static PersonName_type3 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PersonName_type3 object =
                new PersonName_type3();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PersonName_type3".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PersonName_type3)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
