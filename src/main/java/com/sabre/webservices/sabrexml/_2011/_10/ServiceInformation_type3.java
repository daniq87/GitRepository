 ...
 */
            ...
            /**
            *  ServiceInformation_type3 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ServiceInformation_type3
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = ServiceInformation_type3
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ServiceInformation_type3",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ServiceInformation_type3",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static ServiceInformation_type3 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ServiceInformation_type3 object =
                new ServiceInformation_type3();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ServiceInformation_type3".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ServiceInformation_type3)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
