 ...
 */
            ...
            /**
            *  Tax_type2 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Tax_type2
    ...
    public static class Factory{
        ...
        */
        public static Tax_type2 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Tax_type2 object =
                new Tax_type2();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Tax_type2".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Tax_type2)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
