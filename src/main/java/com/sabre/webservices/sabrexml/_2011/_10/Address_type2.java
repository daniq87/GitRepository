 ...
 */
            ...
            /**
            *  Address_type2 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Address_type2
    ...
    public static class Factory{
        ...
        */
        public static Address_type2 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Address_type2 object =
                new Address_type2();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Address_type2".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Address_type2)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    list1.add(reader.getElementText());
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://webservices.sabre.com/sabreXML/2011/10","AddressLine").equals(reader.getName())){
                                                         list1.add(reader.getElementText());
