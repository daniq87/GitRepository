 ...
 */
            ...
            /**
            *  Vendor_type1 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Vendor_type1
    ...
    public static class Factory{
        ...
        */
        public static Vendor_type1 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Vendor_type1 object =
                new Vendor_type1();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Vendor_type1".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Vendor_type1)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
