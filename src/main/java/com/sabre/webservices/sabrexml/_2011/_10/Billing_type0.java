 ...
 */
            ...
            /**
            *  Billing_type0 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Billing_type0
    ...
    public static class Factory{
        ...
        */
        public static Billing_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Billing_type0 object =
                new Billing_type0();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Billing_type0".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Billing_type0)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
