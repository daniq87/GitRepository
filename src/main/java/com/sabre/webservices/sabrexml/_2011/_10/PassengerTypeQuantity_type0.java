...
/**
 * PassengerTypeQuantity_type0.java
 *
 ...
 */
            ...
            /**
            *  PassengerTypeQuantity_type0 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class PassengerTypeQuantity_type0
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = PassengerTypeQuantity_type0
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PassengerTypeQuantity_type0",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "PassengerTypeQuantity_type0",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static PassengerTypeQuantity_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PassengerTypeQuantity_type0 object =
                new PassengerTypeQuantity_type0();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PassengerTypeQuantity_type0".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PassengerTypeQuantity_type0)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
