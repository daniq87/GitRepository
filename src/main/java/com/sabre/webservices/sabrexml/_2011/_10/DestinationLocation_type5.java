...
/**
 * DestinationLocation_type5.java
 *
 ...
 */
            ...
            /**
            *  DestinationLocation_type5 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DestinationLocation_type5
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = DestinationLocation_type5
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DestinationLocation_type5",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DestinationLocation_type5",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static DestinationLocation_type5 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DestinationLocation_type5 object =
                new DestinationLocation_type5();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DestinationLocation_type5".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DestinationLocation_type5)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
