 ...
 */
            ...
            /**
            *  Vendor_type3 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Vendor_type3
    ...
    public static class Factory{
        ...
        */
        public static Vendor_type3 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Vendor_type3 object =
                new Vendor_type3();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Vendor_type3".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Vendor_type3)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
