 ...
 */
            ...
            /**
            *  Corporate_type0 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Corporate_type0
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Corporate_type0".equals(type)){
                                ...
                                return (Corporate_type0)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    list1.add(reader.getElementText());
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://webservices.sabre.com/sabreXML/2011/10","ID").equals(reader.getName())){
                                                         list1.add(reader.getElementText());
