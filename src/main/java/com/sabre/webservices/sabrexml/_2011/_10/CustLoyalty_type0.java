 ...
 */
            ...
            /**
            *  CustLoyalty_type0 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CustLoyalty_type0
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = CustLoyalty_type0
                ...
                */
                        ...
                        */
                                    ...
                                    protected java.lang.String localCodeshare ;
                           ...
                           */
                           public  java.lang.String getCodeshare(){
                            ...
                            /**
                               ...
                               */
                               public void setCodeshare(java.lang.String param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CustLoyalty_type0",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CustLoyalty_type0",
                           xmlWriter);
                                            ...
                                            if (localCodeshare != null){
                                        
                                                writeAttribute("",
                                                         "Codeshare",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCodeshare), xmlWriter);
                                            ...
                                            if (localProgramID != null){
                                                ...
                                                writeAttribute("",
                                                         "ProgramID",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localProgramID), xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            attribList.add(
                            new javax.xml.namespace.QName("","Codeshare"));
                            
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCodeshare));
                            ...
                            attribList.add(
                            new javax.xml.namespace.QName("","ProgramID"));
                            
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localProgramID));
    ...
    public static class Factory{
        ...
        */
        public static CustLoyalty_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CustLoyalty_type0 object =
                new CustLoyalty_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CustLoyalty_type0".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CustLoyalty_type0)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    // handle attribute "Codeshare"
                    java.lang.String tempAttribCodeshare =
                        
                                reader.getAttributeValue(null,"Codeshare");
                            
                   if (tempAttribCodeshare!=null){
                         java.lang.String content = tempAttribCodeshare;
                        
                                                 object.setCodeshare(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(tempAttribCodeshare));
                                            
                    } else {
                       
                    }
                    handledAttributes.add("Codeshare");
                   ...
                   if (tempAttribMembershipID!=null){
                         java.lang.String content = tempAttribMembershipID;
                                                 ...
                                                 object.setMembershipID(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(tempAttribMembershipID));
                   ...
                   if (tempAttribNameNumber!=null){
                    ...
                    // handle attribute "ProgramID"
                    java.lang.String tempAttribProgramID =
                        
                                reader.getAttributeValue(null,"ProgramID");
                            
                   if (tempAttribProgramID!=null){
                         java.lang.String content = tempAttribProgramID;
                        
                                                 object.setProgramID(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(tempAttribProgramID));
                                            
                    } else {
                       
                    }
                    handledAttributes.add("ProgramID");
