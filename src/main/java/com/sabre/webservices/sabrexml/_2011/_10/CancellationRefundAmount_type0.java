...
/**
 * CancellationRefundAmount_type0.java
 *
 ...
 */
            ...
            /**
            *  CancellationRefundAmount_type0 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CancellationRefundAmount_type0
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = CancellationRefundAmount_type0
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CancellationRefundAmount_type0",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CancellationRefundAmount_type0",
                           xmlWriter);
                   }
    ...
    public static class Factory{
                ...
                public static CancellationRefundAmount_type0 fromString(java.lang.String value,
                                                    java.lang.String namespaceURI){
                    CancellationRefundAmount_type0 returnValue = new  CancellationRefundAmount_type0();
                ...
                public static CancellationRefundAmount_type0 fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return CancellationRefundAmount_type0.Factory.fromString(content,namespaceUri);
                    } else {
                       return CancellationRefundAmount_type0.Factory.fromString(content,"");
                    }
                }
        ...
        */
        public static CancellationRefundAmount_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CancellationRefundAmount_type0 object =
                new CancellationRefundAmount_type0();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CancellationRefundAmount_type0".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CancellationRefundAmount_type0)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
