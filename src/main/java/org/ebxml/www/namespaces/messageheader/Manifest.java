                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Manifest".equals(type)){
                                ...
                                return (Manifest)org.xmlsoap.schemas.soap.envelope.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                   ...
                   if (tempAttribVersion!=null){
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    list1.add(org.ebxml.www.namespaces.messageheader.Reference_type0.Factory.parse(reader));
