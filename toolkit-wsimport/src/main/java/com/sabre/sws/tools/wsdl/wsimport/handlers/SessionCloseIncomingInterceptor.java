 ...
 */
public class SessionCloseIncomingInterceptor implements SOAPHandler {

    private static final Logger LOGGER = LogManager.getLogger( SessionCloseIncomingInterceptor.class );
